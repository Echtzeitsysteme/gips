 ...
 * @param terms         : List<ILPWeightedLinearFunction<T>> -> List of linear
 ...
 *                      ILPNestedLinearFunction: f(ILPWeightedLinearFunctions,
 *                      ILPConstants) = Sum_{func in ILPWeightedLinearFunctions}
 *                      ( func.weight * (Sum_{term in func.terms} term.variable
