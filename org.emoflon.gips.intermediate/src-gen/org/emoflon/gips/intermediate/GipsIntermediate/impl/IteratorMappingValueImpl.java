 ...
 * </p>
 * <ul>
 *   <li>{@link org.emoflon.gips.intermediate.GipsIntermediate.impl.IteratorMappingValueImpl#getStream <em>Stream</em>}</li>
 *   <li>{@link org.emoflon.gips.intermediate.GipsIntermediate.impl.IteratorMappingValueImpl#getMappingContext <em>Mapping Context</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IteratorMappingValueImpl extends ValueExpressionImpl implements IteratorMappingValue {
	...
	protected EClass eStaticClass() {
		return GipsIntermediatePackage.Literals.ITERATOR_MAPPING_VALUE;
	}
			...
			if (stream != oldStream) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GipsIntermediatePackage.ITERATOR_MAPPING_VALUE__STREAM, oldStream, stream));
			}
		}
		return stream;
	}
	...
	public Mapping getMappingContext() {
		if (mappingContext != null && mappingContext.eIsProxy()) {
			...
			if (mappingContext != oldMappingContext) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GipsIntermediatePackage.ITERATOR_MAPPING_VALUE__MAPPING_CONTEXT, oldMappingContext,
							mappingContext));
			}
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case GipsIntermediatePackage.ITERATOR_MAPPING_VALUE__STREAM:
			if (resolve)
				return getStream();
			return basicGetStream();
		case GipsIntermediatePackage.ITERATOR_MAPPING_VALUE__MAPPING_CONTEXT:
			if (resolve)
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Iterator.class) {
			...
			case GipsIntermediatePackage.ITERATOR__STREAM:
				return GipsIntermediatePackage.ITERATOR_MAPPING_VALUE__STREAM;
			default:
				return -1;
			}
		}
