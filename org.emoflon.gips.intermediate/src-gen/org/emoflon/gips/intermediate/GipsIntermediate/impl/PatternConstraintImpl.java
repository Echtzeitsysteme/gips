 ...
 * </p>
 * <ul>
 *   <li>{@link org.emoflon.gips.intermediate.GipsIntermediate.impl.PatternConstraintImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.emoflon.gips.intermediate.GipsIntermediate.impl.PatternConstraintImpl#isDepending <em>Depending</em>}</li>
 *   <li>{@link org.emoflon.gips.intermediate.GipsIntermediate.impl.PatternConstraintImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link org.emoflon.gips.intermediate.GipsIntermediate.impl.PatternConstraintImpl#isConstant <em>Constant</em>}</li>
 *   <li>{@link org.emoflon.gips.intermediate.GipsIntermediate.impl.PatternConstraintImpl#isNegated <em>Negated</em>}</li>
 *   <li>{@link org.emoflon.gips.intermediate.GipsIntermediate.impl.PatternConstraintImpl#getDependencies <em>Dependencies</em>}</li>
 *   <li>{@link org.emoflon.gips.intermediate.GipsIntermediate.impl.PatternConstraintImpl#getReferencedBy <em>Referenced By</em>}</li>
 *   <li>{@link org.emoflon.gips.intermediate.GipsIntermediate.impl.PatternConstraintImpl#getSymbolicVariable <em>Symbolic Variable</em>}</li>
 *   <li>{@link org.emoflon.gips.intermediate.GipsIntermediate.impl.PatternConstraintImpl#getHelperVariables <em>Helper Variables</em>}</li>
 *   <li>{@link org.emoflon.gips.intermediate.GipsIntermediate.impl.PatternConstraintImpl#getHelperConstraints <em>Helper Constraints</em>}</li>
 *   <li>{@link org.emoflon.gips.intermediate.GipsIntermediate.impl.PatternConstraintImpl#getPattern <em>Pattern</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PatternConstraintImpl extends MinimalEObjectImpl.Container implements PatternConstraint {
	...
	public void setNegated(boolean newNegated) {
		...
		negated = newNegated;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GipsIntermediatePackage.PATTERN_CONSTRAINT__NEGATED,
					oldNegated, negated));
	}
			...
			if (referencedBy != oldReferencedBy) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GipsIntermediatePackage.PATTERN_CONSTRAINT__REFERENCED_BY, oldReferencedBy, referencedBy));
			}
		}
		return referencedBy;
	}
	...
	public NotificationChain basicSetReferencedBy(Constraint newReferencedBy, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					GipsIntermediatePackage.PATTERN_CONSTRAINT__REFERENCED_BY, oldReferencedBy, newReferencedBy);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setReferencedBy(Constraint newReferencedBy) {
		if (newReferencedBy != referencedBy) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					GipsIntermediatePackage.PATTERN_CONSTRAINT__REFERENCED_BY, newReferencedBy, newReferencedBy));
	}
	...
	public Variable getSymbolicVariable() {
		if (symbolicVariable != null && symbolicVariable.eIsProxy()) {
			...
			if (symbolicVariable != oldSymbolicVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							GipsIntermediatePackage.PATTERN_CONSTRAINT__SYMBOLIC_VARIABLE, oldSymbolicVariable,
							symbolicVariable));
			}
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case GipsIntermediatePackage.PATTERN_CONSTRAINT__REFERENCED_BY:
			if (referencedBy != null)
				msgs = ((InternalEObject) referencedBy).eInverseRemove(this,
						GipsIntermediatePackage.CONSTRAINT__DEPENDENCIES, Constraint.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case GipsIntermediatePackage.PATTERN_CONSTRAINT__CONSTANT:
			return isConstant();
		case GipsIntermediatePackage.PATTERN_CONSTRAINT__NEGATED:
			return isNegated();
		case GipsIntermediatePackage.PATTERN_CONSTRAINT__DEPENDENCIES:
		...
		case GipsIntermediatePackage.PATTERN_CONSTRAINT__SYMBOLIC_VARIABLE:
			if (resolve)
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Constraint.class) {
			...
			case GipsIntermediatePackage.CONSTRAINT__NEGATED:
				return GipsIntermediatePackage.PATTERN_CONSTRAINT__NEGATED;
			...
			case GipsIntermediatePackage.CONSTRAINT__REFERENCED_BY:
				return GipsIntermediatePackage.PATTERN_CONSTRAINT__REFERENCED_BY;
			case GipsIntermediatePackage.CONSTRAINT__SYMBOLIC_VARIABLE:
				return GipsIntermediatePackage.PATTERN_CONSTRAINT__SYMBOLIC_VARIABLE;
