...
public class BooleanExpressionTransformer<T extends EObject> extends TransformationContext<T> {
	...
	protected BooleanExpressionTransformer(RoamTransformationData data, T context, TransformerFactory factory) {
	...
	public BoolExpression transform(RoamBoolExpr eBool) throws Exception {
		if (eBool instanceof RoamBooleanLiteral eLitBool) {
			...
			if (eRelBool.getRight() == null) {
				...
				if (eRelBool.getLeft() instanceof RoamExpressionOperand
						&& eRelBool.getLeft() instanceof RoamAttributeExpr eOperand) {
