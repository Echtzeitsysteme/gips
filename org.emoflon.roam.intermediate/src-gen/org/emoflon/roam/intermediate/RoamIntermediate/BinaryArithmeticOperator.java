 ...
 *
 * @see org.emoflon.roam.intermediate.RoamIntermediate.RoamIntermediatePackage#getBinaryArithmeticOperator()
 * @model
 * @generated
 */
public enum BinaryArithmeticOperator implements Enumerator {
	...
	public static BinaryArithmeticOperator get(String literal) {
		for (BinaryArithmeticOperator result : VALUES_ARRAY) {
