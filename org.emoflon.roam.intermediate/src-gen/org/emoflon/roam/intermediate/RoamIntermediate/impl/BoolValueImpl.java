...
public class BoolValueImpl extends BoolValueExpressionImpl implements BoolValue {
	...
	protected EClass eStaticClass() {
		return RoamIntermediatePackage.Literals.BOOL_VALUE;
	}
	...
	public NotificationChain basicSetValue(ValueExpression newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RoamIntermediatePackage.BOOL_VALUE__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RoamIntermediatePackage.BOOL_VALUE__VALUE, null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RoamIntermediatePackage.BOOL_VALUE__VALUE, newValue,
					newValue));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RoamIntermediatePackage.BOOL_VALUE__VALUE:
