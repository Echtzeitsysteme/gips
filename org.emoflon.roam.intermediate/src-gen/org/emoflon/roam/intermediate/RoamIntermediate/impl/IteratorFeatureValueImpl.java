...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Iterator Feature Value</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emoflon.roam.intermediate.RoamIntermediate.impl.IteratorFeatureValueImpl#getFeatureExpression <em>Feature Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IteratorFeatureValueImpl extends IteratorValueImpl implements IteratorFeatureValue {
	/**
	 ...
	 * @generated
	 */
	protected IteratorFeatureValueImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return RoamIntermediatePackage.Literals.ITERATOR_FEATURE_VALUE;
	}
	...
	public NotificationChain basicSetFeatureExpression(FeatureExpression newFeatureExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RoamIntermediatePackage.ITERATOR_FEATURE_VALUE__FEATURE_EXPRESSION, oldFeatureExpression,
		...
		if (newFeatureExpression != featureExpression) {
			...
			if (featureExpression != null)
				msgs = ((InternalEObject) featureExpression).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - RoamIntermediatePackage.ITERATOR_FEATURE_VALUE__FEATURE_EXPRESSION,
						null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RoamIntermediatePackage.ITERATOR_FEATURE_VALUE__FEATURE_EXPRESSION, newFeatureExpression,
					newFeatureExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RoamIntermediatePackage.ITERATOR_FEATURE_VALUE__FEATURE_EXPRESSION:
