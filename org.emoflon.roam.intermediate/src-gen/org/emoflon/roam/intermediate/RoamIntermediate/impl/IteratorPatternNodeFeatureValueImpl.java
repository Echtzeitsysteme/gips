...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Iterator Pattern Node Feature Value</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.emoflon.roam.intermediate.RoamIntermediate.impl.IteratorPatternNodeFeatureValueImpl#getFeatureExpression <em>Feature Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IteratorPatternNodeFeatureValueImpl extends IteratorPatternNodeValueImpl
	...
	protected EClass eStaticClass() {
		return RoamIntermediatePackage.Literals.ITERATOR_PATTERN_NODE_FEATURE_VALUE;
	}
	...
	public NotificationChain basicSetFeatureExpression(FeatureExpression newFeatureExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					RoamIntermediatePackage.ITERATOR_PATTERN_NODE_FEATURE_VALUE__FEATURE_EXPRESSION,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case RoamIntermediatePackage.ITERATOR_PATTERN_NODE_FEATURE_VALUE__FEATURE_EXPRESSION:
